...
export default function HomeSection() {
	return (
		<>
			<div id="Home__Content" className="m-0 p-2 pb-0 pt-24 bg-black sm:flex sm:h-screen text-white">
				<div id="Hero" className="flex flex-col justify-center items-center w-full h-full text-center sm:w-4/6 sm:m-2 sm:mb-0">
					...
					<ButtonSecondary content="Get Started" icon={<AiOutlineArrowUp className='mb-1 ml-1 rotate-45'/>} pageRef={"/signup"} />
				</div>
				<img alt="Credit Card" src={Card} className="mt-10 sm:w-4/5 sm:h-4/5 md:h-auto md:w-auto"/>
			</div>
			<img id="Home_Wave" src={Wave} alt="Wave" />
		</>
	)
}
